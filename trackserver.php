...
EOF;
            ...
            function load_common_scripts() {
                ...
                wp_register_script( 'trackserver', TRACKSERVER_PLUGIN_URL .'trackserver.js?2', array(), TRACKSERVER_VERSION, true );
...
EOF;
            ...
            function handle_shortcode( $atts ) {
                ...
                $is_ext_live = ( in_array( $atts['live'],       array( 'false', 'f', 'no',  'n', false ), true ) ? false  : true );  // default false
                ...
                $mapdata = array(
                    ...
                    'default_zoom' => $zoom,
                    'fullscreen'   => true,
                    'is_live'      => $is_live, // set live if tracks needs live update
                    'is_ext_live'  => $is_ext_live, // to force refress external GPX,KLM files 
